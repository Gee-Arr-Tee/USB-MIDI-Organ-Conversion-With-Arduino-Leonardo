 ...
 * using only 4 ANALOGUE Pins. You need to do this if you want to
 * connect 3 x 61 Key Keyboards and a Pedal Board.
 ...
 *  --------------------------------------------------------------
 *  Using the Analog Pins as Digital Pins on Leonardo
 *  'KBoard.begin(14, 15, 16, 17);' Will NOT work 
 *  'KBoard.begin(A0, A1, A2, A3);' Works 
 *  --------------------------------------------------------------
 *  Connects to 74HC165N Pins to the Leoardo Pins in Order Below
 *  74HC165N Pins (1,  15, 9,  2)
 *  Leonardo Pins (A0, A1, A2, A3)
 */
KBoard.begin(A0, A1, A2, A3);
}
